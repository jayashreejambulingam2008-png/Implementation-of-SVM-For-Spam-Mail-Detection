...
## Algorithm
1. Import the required libraries and create the spam/ham message dataset.
2. Convert text messages into numerical features using TF-IDF vectorization.
3. Split the dataset into training and testing sets and train the SVM classifier.
4. Make predictions, evaluate the model performance, and classify new messages as Spam or Ham.
...
## Output:
<img width="1426" height="506" alt="image" src="https://github.com/user-attachments/assets/0030ed46-e965-48ac-8980-57aeedddd1e7" />
